...
public class EditNoteActivity_OLD extends Activity {
    private Note note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noteDBAdapter = new NoteDBAdapter(EditNoteActivity_OLD.this);
        ...
        dateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DateTimeDialog dateTimeDialog = new DateTimeDialog(EditNoteActivity_OLD.this,note);
                dateTimeDialog.show();
        ...
        buttonCheckList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                CheckListDialog checkListDialog = new CheckListDialog(EditNoteActivity_OLD.this,note);
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if(isChecked)
                {
                    switch (note.getNoteState()){
                        case COMPLETED:
                            Toast.makeText(EditNoteActivity_OLD.this, R.string.errorNoNeedForAlarm, Toast.LENGTH_SHORT).show();
                            break;
                        case EXPIRED:
                            Toast.makeText(EditNoteActivity_OLD.this, R.string.errorDateTimePassed, Toast.LENGTH_SHORT).show();
                            break;
                        default:
                ...
                {
                    AlarmManager alarmManager = (AlarmManager) EditNoteActivity_OLD.this.getSystemService(ALARM_SERVICE);
                    Intent intentAlarm = new Intent(EditNoteActivity_OLD.this, AlarmReceiver.class);
                    alarmManager.cancel(PendingIntent.getBroadcast(EditNoteActivity_OLD.this, 1, intentAlarm, PendingIntent.FLAG_UPDATE_CURRENT));
                }
            }
        });
        ...
        ArrayAdapter<String> priorities = new ArrayAdapter<>(EditNoteActivity_OLD.this, android.R.layout.simple_spinner_item, new Importance().getAllPriorities());
        ...
        ArrayAdapter<String> urgencies = new ArrayAdapter<>(EditNoteActivity_OLD.this, android.R.layout.simple_spinner_item, new Importance().getAllUrgencies());
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editTextTitle.getText().toString().length()>0)
                {
                    ...
                    Toast.makeText(EditNoteActivity_OLD.this, R.string.messageChangesApplied, Toast.LENGTH_SHORT).show();
                    finish();
                    overridePendingTransition(0,0);
                }
                else
                {
                    Toast.makeText(EditNoteActivity_OLD.this, R.string.errorEmptyTitle, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(EditNoteActivity_OLD.this, R.string.messageChangesNotApplied,Toast.LENGTH_SHORT).show();
                finish();
                overridePendingTransition(0,0);
            }
        });
    ...
    public void planNotification(Note note) {
        ...
        AlarmManager alarmManager = (AlarmManager) EditNoteActivity_OLD.this.getSystemService(ALARM_SERVICE);
        alarmManager.set(AlarmManager.RTC_WAKEUP, when, PendingIntent.getBroadcast(EditNoteActivity_OLD.this, 1, intentAlarm, PendingIntent.FLAG_UPDATE_CURRENT));
    }
}
